...
def lector_required(function=None, redirect_field_name=REDIRECT_FIELD_NAME, login_url='/news/login'):
    '''
...
def periodista_required(function=None, redirect_field_name=REDIRECT_FIELD_NAME, login_url='/news/login'):
    """
    Decorator for views that checks that the logged-in user is a lector,
    redirects to the log-in page if necessary.
    """
    actual_decorator = user_passes_test(
